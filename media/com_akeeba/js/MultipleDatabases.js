        ...
        akeeba.System.addEventListener(elEditorDefault, 'click', function ()
		{
			...
			akeeba.System.doAjax(query, function (response)
			{
				...
				if (response.status == true)
				{
					...
					elEditorNotifierContent.textContent = akeeba.System.Text._('COM_AKEEBA_MULTIDB_GUI_LBL_CONNECTOK');
				}
				else
				{
			...
			}, function (message)
			{
				...
				document.getElementById('ak_editor_notifier').className = 'akeeba-block--failure';
				elEditorNotifierContent.textContent = akeeba.System.Text._('COM_AKEEBA_MULTIDB_GUI_LBL_CONNECTFAIL')
