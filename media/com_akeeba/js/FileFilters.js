...
akeeba.Fsfilters.render = function (data)
{
    ...
    if (Object.keys(data.folders).length > 0)
    {
        ...
        for (var index = 0; index < headerFilters.length; index++)
        {
            ...
            // ui_icon.setAttribute("title", "<div class=\"tooltip-arrow-up-leftaligned\"></div><div>" +
            //     akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_" + filter.toUpperCase()) + "</div>");
        ...
        elButton.innerHTML = "<span class=\"pull-left akion-arrow-down-a\"></span>" +
            akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLDIRS");
    ...
    if (Object.keys(data.files).length > 0)
    {
        ...
        // ui_icon.setAttribute("title", "<div class=\"tooltip-arrow-up-leftaligned\"></div><div>" +
        //     akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_FILES_ALL") + "</div>");
        // ui_icon.setAttribute("data-akeeba-tooltip-position", "right");
        //akeeba.Tooltip.simpleTooltip(ui_icon);
        ...
        elFilename.innerHTML = "<span class=\"pull-left akion-arrow-down-a\"></span>" +
            akeeba.System.Text._("COM_AKEEBA_FILEFILTERS_TYPE_APPLYTOALLFILES");
...
akeeba.Fsfilters.addRow = function (def, append_to_here)
{
    ...
    elDeleteButton.insertAdjacentHTML(
        "beforeend",
        "<span class=\"ak-toggle-button akion-trash-a deletebutton\"></span>"
    );
