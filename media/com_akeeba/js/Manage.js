...
akeeba.Manage.confirmDownload = function (e)
{
    ...
    var newURL = akeeba.System.getOptions("akeeba.Manage.baseURI") +
        "index.php?option=com_akeeba&view=Manage&task=download&id=" + id;
...
akeeba.Loader.add(['akeeba.System', 'akeeba.Tooltip', 'akeeba.Modal'], function ()
{
    // Enable tooltips
    ...
    // Frozen filter event handler
    akeeba.System.addEventListener("comAkeebaManageFrozenSelector", "change", function ()
    {
        document.forms.adminForm.submit();
    });
});